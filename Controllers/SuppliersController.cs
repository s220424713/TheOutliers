...
namespace Outliers_E_Commerce.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Supplierid,Name,Email,deliveryData")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Supplierid,Name,Email,deliveryData")] Supplier supplier)
        {
